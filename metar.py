...
LED_BRIGHTNESS          = .3                    # Float from 0.0 (min) to 1.0 (max)
...
LOCATION                = "Columbus"            # Nearby city for Sunset/Sunrise timing, refer to https://astral.readthedocs.io/en/latest/#cities for list of cities supported
